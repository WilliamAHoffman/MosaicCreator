...
Next you must erase the example palette in the file called "Palette.txt". This file is the opposite of the "anti-Palette.txt" file. It only allows textrures to be used which are included in the file. I have provided some example palettes for whiteList in "unusedPallet.txt". 
